...
<!-- Detail -->
    <div class="detail-user-info">
        ...
        <div class="block-regis">
            ...
            <div class="radio-box">
                <input type="radio" class="radiobtn" name="institutetype" value="HighScool" <?php ($data[0]['institute_type']=="HighScool")?print("checked"):print("disabled")?>><?php echo "มัธยมศึกษาหรือเทียบเท่า"; ?>
            </div>
            <div class="">
                <input type="radio" class="radiobtn" name="institutetype" value="University" <?php ($data[0]['institute_type']=="University")?print("checked"):print("disabled")?>><?php echo "อุดมศึกษาหรือเทียบเท่า"; ?>
            </div>
        </div>
		...
		<div class="block-regis">
            ...
            <div class="detail-left-300 required">
               <input type="textbox" class="txtbox required" value="<?php echo $data[0]['advisor_title'];?>" name="advisor_title">
            </div>
		</div>
        ...
        <div class="block-regis"> <!-- AdvisorName-->
            ...
            <div class="detail-left-300 required">
                <input type="textbox" class="txtbox required" value="<?php echo $data[0]['advisor_name'];?>" name="advisor_name">
            </div>
            ...
            <div class="detail-right required">
                <input type="textbox" class="txtbox required" value="<?php echo $data[0]['advisor_email'];?>" name="advisor_email">
            </div>
        </div>
		...
		<div class="block-regis"> <!-- AdvisorName-->
            ...
            <div class="detail-left-300 required">
                <input type="textbox" class="txtbox required" value="<?php echo $data[0]['advisor_last_name'];?>" name="advisor_last_name">
            </div>
            ...
            <div class="detail-right required">
                 <input type="textbox" class="txtbox required" value="<?php echo $data[0]['advisor_telephone'];?>" name="advisor_telephone">
            </div>
        </div>
		 ...
		 <div class="block-regis">
            ...
            <div class="detail-left-300 required">
               <input type="textbox" class="txtbox required" value="<?php echo $data[0]['leader_title'];?>" name="leader_title">
            </div>
		</div>
		 ...
		 <div class="block-regis"> <!-- Header-->
            ...
            <div class="detail-left-300 required">
                <input type="textbox" class="txtbox required" value="<?php (isset($data[0]['leader_first_name'])?print($data[0]['leader_first_name']):"");?>" name="leaderfirstname">
            </div>
            <div class="detail-left-100">
                <?php echo "อีเมล์"; ?>
            </div>
            <div class="detail-right required">
                <input type="textbox" class="txtbox required" value="<?php echo $data[0]['leader_email'];?>" name="leaderemail">
            </div>
        </div>
        ...
        <div class="block-regis">
            ...
            <div class="detail-left-300 required">
                <input type="textbox" class="txtbox required" value="<?php (isset($data[0]['leader_last_name'])?print($data[0]['leader_last_name']):"");?>" name="leaderlastname">
            </div>
            <div class="detail-left-100">
                <?php echo "เบอร์โทรศัพท์ที่ติดต่อได้"; ?>
            </div>
            <div class="detail-right required">
                <input type="textbox" class="txtbox required" value="<?php echo $data[0]['telephone'];?>" name="telephone">
            </div>
		</div>
		...
		<div class="block-regis">
            ...
            <div class="detail-left-300 required">
                <input type="textbox" maxlength="13" class="txtbox required" value="<?php (isset($data[0]['leader_id'])?print($data[0]['leader_id']):"");?>" name="leaderid">
            </div>
        </div>
		<div class="block-regis">
			<div class="detail-left-100">
				<?php echo "ไฟล์บัตรประชาชน pdf"; ?>
			</div>
			<div class="detail-right">
			...
			<?php }else{ ?>
            	<input type="file" class="fileupload" value="" name="file0" id="file0">
            <?php } ?>
                </div>
			</div>
		</div>
	...
	<tr>
		<td class="userinfotd" style="width:50%:margin-top:10px;" id="1">
			...
			<div class="block-regis">
				...
				<?php }else{ ?>
                	<input type="file" class="fileupload" value="" name="file1" id="file1">
                <?php } ?>
                    </div>
				</div>
			</div>
		...
		<td id="2" >
			...
			<div class="block-regis">
				...
				<?php }else{ ?>
                	<input type="file" class="fileupload" value="" name="file2" id="file2">
                <?php } ?>
                    </div>
				</div>
			</div>
	...
	<tr>
		<td id="3" style="border-top-style: solid; border-top-width: 1px; border-top-color: #d7d7d7;padding-top5px;padding-bottom:10px;">
			...
			<div class="block-regis">
				...
				<?php }else{ ?>
                	<input type="file" class="fileupload" value="" name="file3" id="file3">
                <?php } ?>
                    </div>
				</div>
			</div>
		...
		<td id="4" style="border-top-style: solid; border-top-width: 1px; border-top-color: #d7d7d7;padding-top5px;padding-bottom:10px">
			...
			<div class="block-regis">
				...
				<?php }else{ ?>
                	<input type="file" class="fileupload" value="" name="file4" id="file4">
                <?php } ?>
                    </div>
				</div>
			</div>
...
<div class="head-title">ข้อมูลผู้ใช้งาน</div>
<div class="page-info">
<!-- Detail -->
    <div class="detail-user-info">
        <div class="block-regis"> <!-- Username-->
            <div class="detail-left-100">
                <?php echo "ชื่อผู้ใช้งาน"; ?>
            </div>
            <div class="detail-right">
                <input type="textbox" class="txtbox" value="<?php echo $data[0]['user_name'];?>" readonly name="username">
            </div>
        </div>
        <div class="block-regis"> <!-- New Password-->
            <div class="detail-left-100">
                <?php echo "รหัสผ่านเก่า"; ?>
            </div>
            <div class="detail-right">
                <input type="password" class="txtbox" value="" name="oldpassword">
            </div>
        </div>
        <div class="block-regis"> <!-- New Password-->
            <div class="detail-left-100">
                <?php echo "กำหนดรหัสผ่านใหม่"; ?>
            </div>
            <div class="detail-right">
                <input type="password" class="txtbox" value="" name="password">
            </div>
        </div>
        <div class="block-regis"> <!-- Confirm New Password-->
            <div class="detail-left-100">
                <?php echo "กำหนดรหัสผ่านใหม่อีกครั้ง"; ?>
            </div>
            <div class="detail-right">
                <input type="password" class="txtbox" value="" name="confirmpassword">
            </div>
        </div>
    </div>	
</div>
